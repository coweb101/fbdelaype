...
# significant effect only for positive (ß=2.88, p=.00) but not negative feedback (ß=.16, p=.79)
...
# effect of prediction error on frn amplitudes only for positive (ß=1.65, p=.01)
# but not negative (ß=.06, p = .91) feedback
